...
nn_distance_module=tf.load_op_library('/orions4-zfs/projects/lins2/Lin_Space/Git_Repos/autopredictors/tf_experiments/Chamfer_EMD_losses/tf_nndistance_so.so')
