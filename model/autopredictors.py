...
class Shape_Auto_Predictor_Toy(object):
    ...
    def __init__(self, is_training, config, input_):
        ...
        vgg_out = vgg_m_conv(inputs, keep_prob)
        
        outputs, state = tf.nn.rnn(encoder, vgg_out, initial_state=self._initial_state)
