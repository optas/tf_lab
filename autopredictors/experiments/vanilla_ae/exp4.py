...
DATA_PATH = '/orions4-zfs/projects/lins2/Panos_Space/DATA/ShapeNetPointClouds/from_manifold_meshes/1024/'
TRAIN_DIR = '/orions4-zfs/projects/lins2/Panos_Space/DATA/OUT/simple_ae_with_chairs/'
experiment_name = 'enc_filter_1_complex_decoder_full_SN'
