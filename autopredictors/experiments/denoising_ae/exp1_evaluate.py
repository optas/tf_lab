...
TRAIN_DIR = '/orions4-zfs/projects/lins2/Panos_Space/DATA/OUT/denoising_ae_with_chairs/'
...
SAVEDIR = osp.join('/orions4-zfs/projects/lins2/Panos_Space/DATA/OUT/model_evaluation/denoising_ae', experiment_name)
create_dir(SAVEDIR)
